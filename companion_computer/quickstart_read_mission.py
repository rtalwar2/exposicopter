...
drone.send_message(f"PI:missions downloaded")
...
# # in the code below, when the pilot clicks on a location in the map, we will fly in a grid pattern over that location
